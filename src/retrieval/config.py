...
BLAME_EXAMPLE_LIMIT = int(os.getenv("BLAME_EXAMPLE_LIMIT", "0"))
BLAME_FILE_LIMIT = int(os.getenv("BLAME_FILE_LIMIT", "0"))
MAX_PRS_WITH_LINKED_ISSUES = int(os.getenv("MAX_PRS_WITH_LINKED_ISSUES", "0"))  # 0 = no cap
MAX_PAGES_PRS = int(os.getenv("MAX_PAGES_PRS", "0"))  # 0 = no cap
